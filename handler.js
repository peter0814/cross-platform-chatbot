...
const welcomeMessage = 'Hi~ 本 Bot 是用 https://rebrand.ly/ic-chatbot-github 開源程式碼打造\n\n' +
    '您可以問我\n' +
    '音樂：「播放怪美的」；「播放自傳專輯的歌」；「我要聽鄉村音樂」；「我要聽日文新歌」\n' + 
    '音樂活動：「查詢高雄的活動」；「查詢吳卓源的演場會」；「查詢兩廳院的表演」\n' +
    '影音內容：「查詢影片排球少年」；「查詢日劇半澤直樹」\n';
...
curl -s \
 ...
 --url 'https://api.kkbox.com/v1.1/albums/Wku_flBDIvVnmt5aQM/tracks' \
 | jq '.data[] | .id' \
 | xargs -n 1 -I % curl -s -H 'Content-Type: application/json' \
 -H 'Authorization: Bearer '${TOKEN} \
